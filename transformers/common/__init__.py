...
hf_sd15_model = os.getenv("HF_SD1_MODEL", "stable-diffusion-v1-5/stable-diffusion-v1-5")
hf_sd35_model = os.getenv("HF_SD3_MODEL", "stabilityai/stable-diffusion-3.5-medium")
